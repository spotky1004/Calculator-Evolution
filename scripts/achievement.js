(function(){
  achievementName = [
    ...
    'Richer', 'A to Œ', 'Coming Soon', 'Infinity Boost'
  ];
  achievementGoal = [
    ...
    'Have ${dNotation(1e1000, 4, 0)} $', 'Reach base ${dNotation(250, 4, 0)}', 'Coming Soon', 'Have ${dNotation(1024, 4, 0)} Qubits'
  ];
  achievementGoalFunc = [
    ...
    'game.money.gte(\'1e1000\')', 'game.base.gte(250)', '0', 'game.qubit.gte(1024)'
  ];
