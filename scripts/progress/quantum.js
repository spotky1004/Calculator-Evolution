(function(){
  ...
  quantumUpgradeDesc = [
    ...
    [
      ...
      "Each Grey digit boosts CPU by x30 (x${dNotation(D(30).pow(D.max(0, calcMaxDigit().sub(calcMaxDigit().lt(2000)?game.digits:0))), 4, 0)})<br><b style=\"opacity: 0.6\">If max base is bigger than 1000, this bonus will based on max Digit</b>",
